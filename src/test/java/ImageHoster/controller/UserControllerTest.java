...
public class UserControllerTest {
    ...
    //This test checks the controller logic for user signup
    //when user fills the form and send the POST request 
    //to the server with the correct password type and 
    //checks whether the logic returns the html file 'users/login.html'
    @Test
